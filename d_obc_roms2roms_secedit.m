...
NWAdata = 'ocean_rst_run03v6.nc';
NWAgrid = 'Combined2016_v8_grd.nc';

GRDname = 'Combined2016_v8_grd.nc';
BRYname = 'Combined2016_v8_bry.nc';

StrDay = datenum('24-Aug-2015');        % starting day to process
EndDay = datenum('02-Oct-2015');        % ending   day to process
...
%  Set attributes for "bry_time".
  ...
  avalue='seconds since 2015-08-24 00:00:00';
...
%  Set global attribute.
  ...
  avalue='Great Bay Grid, ~30 m resolution, Grid v8';
  [status]=nc_attadd(BRYname,'title',avalue);

  avalue='ROMS Great Bay application';
